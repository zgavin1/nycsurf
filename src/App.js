...
class App extends Component {
  ...
  renderLiveStream() {
    if (this.state.currentBeach === beaches.rockaway) {
      return (<div>
        <iframe title="rockaway-beach-feed" width="640" height="360" src="https://e.cdn-surfline.com/syndication/embed/v1/player.html?id=137586" frameBorder="0" scrolling="no" allowFullScreen></iframe>
        <div>
      ...
      return (<div>
        <iframe title="long-beach-feed" width="640" height="360" src="https://e.cdn-surfline.com/syndication/embed/v1/player.html?id=4269" frameBorder="0" scrolling="no" allowFullScreen></iframe>
        <div>
